...
public class Server {
	...
	public void connect() throws IOException{
		...
		this.videoThread = new ConnectionThread(this.portVideoDrone, this.portVideoRemote, this, "video");
		this.commandThread = new ConnectionThread(this.portCommandDrone, this.portCommandRemote, this, "command");
